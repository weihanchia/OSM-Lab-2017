...
def ls_error(n_agents, t1, t2, num_points, zstate):
    file=open('errors' + str(zstate) + '.txt', 'w')
    ...
    for i in range(t1, t2):
        ...
        v_prev.read("valnew_" + str(zstate) + str(i) + ".txt")
        v_next.read("valnew_" + str(zstate) + str(i+1) + ".txt")
